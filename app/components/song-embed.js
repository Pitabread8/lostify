        ...
        <>
            {
                ...
                <div className="flex flex-col items-center gap-2 md:gap-0 justify-center">
                    <iframe className="rounded-xl h-24 md:w-[50vw] md:h-72" title="Spotify Embed" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy" src={`https://open.spotify.com/embed/track/${trackData["items"][0]["external_urls"]["spotify"].substring(31)}`}></iframe>
